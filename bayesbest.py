# CS 510: Homework 2
# Naive Bayesian Classification with Unigram/Bigram features
# By Greg Matthews
# 11/21/17
...
pos_words_filename = "pos_words_best"
neg_words_filename = "neg_words_best"
...
class Bayes_Classifier:
    ...
    def train(self):
        ...
        for f in iFileList:
            ...
            for i, word in enumerate(tokens):
                ...
                # Include bigrams into dictionary
                if words.has_key(bigram):
                    words[bigram] += 1
                else:
                    words[bigram] = 1

                # Include unigrams into dictionary
    ...
    def classify(self, sText):
        ...
        # Get features of text as bigrams and unigrams
        features_uni = self.tokenize(sText)
        features_bi = features_uni[:]

        for i, word in enumerate(features_uni):
            if i + 1 >= len(features_uni):
                break
            features_bi.append(features_uni[i] + " " + features_uni[i+1])
